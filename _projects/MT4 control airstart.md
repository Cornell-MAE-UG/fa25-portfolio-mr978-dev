...
layout: project
title: MT4 Air-start
description: Multi-motor staged airstart experiment using PerfectFlite MT4 timers.
image: /assets/images/MT4AS1.png
---

## MT4 Air-start

Experimental **multi-motor airstart project** focused on staged ignition for in-flight thrust control using **PerfectFlite MiniTimer 4 (MT4)** units integrated into the lower airframe.
